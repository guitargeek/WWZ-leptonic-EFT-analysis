...
from array_utils import reduce_and, reduce_or
from array_utils import awkward_indices
...
f = uproot.open("../WVZLooper/outputs/" + tag + "/test/CutResults_MC_" + sample_name + "_results.root")
...
# ref = uproot.open("../WVZLooper/outputs/"+tag+"/test/MC_wwz_4l2v_amcatnlo_1_results.root")
